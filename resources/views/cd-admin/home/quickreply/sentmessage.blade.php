...
<div class="content-wrapper">
  ...
  <div class="container-fluid">
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><i class="fa fa-dashboard"></i> Dashboard/Contact/quick mail</li>
      </ol>
    </section>
    <!-- Main content -->
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        ...
                        <a href="{{ route('q.view',$msg->id) }}"><button type="button" class="btn btn-default btn-sm"><i class="fa fa-eye"></i></button></a>
                      </td>
                      <td class="mailbox-name">{{e($msg->emailto)}}</td>
                      <td class="mailbox-subject"><b>{{e($msg->subject)}}</b>
                      </td>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer">
          <form action="{{ route('qmessage.destroy',$msg->id) }}" method="POST">

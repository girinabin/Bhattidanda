                ...
                <div class="box-body">
                  <div class="row ">
                    <div class="col-md-4 rowedit">
                      <img src="{{asset('public/cd-admin/creatu/dist/img/room1.jpg')}}" alt="" height="100%" width="100%">
                      <div class="top-left" style="position: absolute; top: 8px; left: 16px;color: #dfe0e9;">Top Left</div>
                    ...
                    <div class="col-md-4 rowedit">
                      <img src="{{asset('public/cd-admin/creatu/dist/img/room2.jpg')}}" alt="" height="100%" width="100%">
                      <button class="btn btn-danger pull-right buttonedit">Delete</button>
                      <a href="{{ route('imageview') }}"><button class="btn btn-primary pull-left buttonedit">View</button></a>
                    </div>
                    <div class="col-md-4 rowedit">
                      <img src="{{asset('public/cd-admin/creatu/dist/img/room3.jpg')}}" alt="" height="100%" width="100%">
                      <button class="btn btn-danger pull-right buttonedit">Delete</button>
                      <a href="{{ route('imageview') }}"><button class="btn btn-primary pull-left buttonedit">View</button></a>
                    </div>
                    <div class="col-md-4 rowedit">
                      <img src="{{asset('public/cd-admin/creatu/dist/img/food1.jpg')}}" alt="" height="100%" width="100%">
                      <button class="btn btn-danger pull-right buttonedit">Delete</button>
                      <a href="{{ route('imageview') }}"><button class="btn btn-primary pull-left buttonedit">View</button></a>
                    </div>
                    <div class="col-md-4 rowedit">
                      <img src="{{asset('public/cd-admin/creatu/dist/img/farm1.jpg')}}" alt="" height="100%" width="100%">
                      <button class="btn btn-danger pull-right buttonedit">Delete</button>
                      <a href="{{ route('imageview') }}"><button class="btn btn-primary pull-left buttonedit">View</button></a>
                    </div>
